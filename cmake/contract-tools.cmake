...
if(BUILD_SYSTEM_CONTRACTS AND NOT CDT_BUILD)
  ...
  set(FC_LITE_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/libraries/libfc-lite/include)
  message(NOTICE "FC_LITE_INCLUDE_DIR: ${FC_LITE_INCLUDE_DIR}")
  set(CDT_CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${CDT_ROOT}/lib/cmake/cdt/CDTWasmToolchain.cmake -DCMAKE_PREFIX_PATH=${CMAKE_BINARY_DIR} -DCDT_CONTRACT_INCLUDE_PATH=${FC_LITE_INCLUDE_DIR} -DBUILD_SYSTEM_CONTRACTS=ON -DBUILD_TEST_CONTRACTS=${BUILD_TEST_CONTRACTS} -DCDT_BUILD=ON)
endif()
