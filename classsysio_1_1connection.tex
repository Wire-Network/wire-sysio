...
\DoxyCodeLine{02347\ \ \ \ \ \ \ boost::asio::async\_connect(\ *socket,\ endpoints,}
...
\DoxyCodeLine{02349\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [resolver,\ c\ =\ shared\_from\_this(),\ socket=socket](\ \textcolor{keyword}{const}\ boost::system::error\_code\&\ err,\ \textcolor{keyword}{const}\ tcp::endpoint\&\ endpoint\ )\ \{}
\DoxyCodeLine{02350\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ !err\ \&\&\ socket-\/>is\_open()\ \&\&\ socket\ ==\ c-\/>socket\ )\ \{}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsysio_1_1connection_a389358826bf8da3e54bebbd7db92120c_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsysio_1_1connection_aeb1cd3ec121a5ff8d01c2292834923a1_icgraph}
\end{center}
\end{figure}
...
\DoxyCodeLine{01222\ \ \ \ \ \ \ \ \ \ \ \ \ boost::asio::bind\_executor(\ c-\/>strand,\ [c,\ socket=c-\/>socket](\ boost::system::error\_code\ ec,\ std::size\_t\ w\ )\ \{}
...
\DoxyCodeLine{02443\ \ \ \ \ \ \ \ \ \ \ \ \ socket-\/>set\_option(\ read\_watermark\_opt,\ ec\ );}
...
\DoxyCodeLine{02462\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{02463\ }
\DoxyCodeLine{02464\ \ \ \ \ \ \ \ \ \ boost::asio::async\_read(\ *socket,}
...
\DoxyCodeLine{02467\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [conn\ =\ shared\_from\_this(),\ socket=socket](\ boost::system::error\_code\ ec,\ std::size\_t\ bytes\_transferred\ )\ \{}
\DoxyCodeLine{02468\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ may\ have\ closed\ connection\ and\ cleared\ pending\_message\_buffer}}
\DoxyCodeLine{02469\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ !conn-\/>socket\_is\_open()\ ||\ socket\ !=\ conn-\/>socket\ )\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{02470\ }
...
\DoxyCodeLine{00960\ \ \ \ \ \ \ socket-\/>set\_option(\ nodelay,\ ec\ );}
