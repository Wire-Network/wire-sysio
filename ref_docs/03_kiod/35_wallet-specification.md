---
content_title: SYS Wallet Specification
---

## SYS Wallet Import Format (WIF)

Wallet Import Format is an encoding for a private EDSA key.  SYS uses the same version, checksum, and encoding scheme as the Bitcoin WIF addresses and should be compatible with existing libraries [1].
