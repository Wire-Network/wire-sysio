\chapter{changelog}
\hypertarget{md_libraries_2fc_2vendor_2websocketpp_2changelog}{}\label{md_libraries_2fc_2vendor_2websocketpp_2changelog}\index{changelog@{changelog}}
HEAD
...
\item MINOR BREAKING DEPENDENCY CHANGE\+: When using Boost versions greater than or equal to 1.\+49 in C++03 mode, {\ttfamily libboost-\/chrono} is needed now instead of {\ttfamily libboost-\/date\+\_\+time}. Users with C++11 compilers or using Boost versions 1.\+48 and earlier are not affected. Note\+: This change affects the bundled unit test suite.
...
\item Bug\+: Fixes a potential dangling pointer and inconsistent error message handling in {\ttfamily \doxylink{classwebsocketpp_1_1exception}{websocketpp\+::exception}}. \#432 Thank you Tom Swirly for the fix.
\end{DoxyItemize}
...
\item Bug\+: Fixes an issue where {\ttfamily \doxylink{classwebsocketpp_1_1exception_a62dabd977bc59faaca6dc268744a6089}{websocketpp\+::exception\+::what()}} could return an out of scope pointer. \#397 Thank you fabioang for reporting.
...
0.\+4.\+0 -\/ 2014-\/11-\/04
\begin{DoxyItemize}
\item BREAKING API CHANGE\+: All Web\+Socket++ methods now throw an exception of type {\ttfamily \doxylink{classwebsocketpp_1_1exception}{websocketpp\+::exception}} which derives from {\ttfamily std\+::exception}. This normalizes all exception types under the standard exception hierarchy and allows Web\+Socket++ exceptions to be caught in the same statement as others. The error code that was previously thrown is wrapped in the exception object and can be accessed via the {\ttfamily \doxylink{classwebsocketpp_1_1exception_a2ca743bae5d6ba2be63d1a64bc2f878f}{websocketpp\+::exception\+::code()}} method.
...
\item BREAKING UTILITY CHANGE\+: The signature of {\ttfamily base64\+\_\+encode} has changed from {\ttfamily websocketpp\+::base64\+\_\+encode(unsigned char const \texorpdfstring{$\ast$}{*}, unsigned int)} to {\ttfamily \doxylink{namespacewebsocketpp_aff36d40583424a2c879df02219133af8}{websocketpp\+::base64\+\_\+encode(unsigned char const \texorpdfstring{$\ast$}{*}, size\+\_\+t)}}.
\item BREAKING UTILITY CHANGE\+: The signature of {\ttfamily sha1\+::calc} has changed from {\ttfamily websocketpp\+::sha1\+::calc(void const \texorpdfstring{$\ast$}{*}, int, unsigned char \texorpdfstring{$\ast$}{*})} to {\ttfamily \doxylink{namespacewebsocketpp_1_1sha1_ad75335df7a69d69b3fb8fef3f4594812}{websocketpp\+::sha1\+::calc(void const \texorpdfstring{$\ast$}{*}, size\+\_\+t, unsigned char \texorpdfstring{$\ast$}{*})}}
...
\item \doxylink{struct_a}{A} number of internal changes to transport APIs
...
\item Refactors URI to be exception free and not use regular expressions. This eliminates the dependency on boost or C++11 regex libraries allowing native C++11 usage on GCC 4.\+4 and higher and significantly reduces staticly built binary sizes.
