   ...
   inline void from_variant(const fc::variant& v, params::permission_level& a) {
      if (v.is_string()) {
         ...
         if(vo.contains("actor"))
            ...
            EOS_THROW(sysio::chain::invalid_http_request, "Missing Actor field");
         ...
         if(vo.contains("permission") && vo.size() == 2)
            ...
            EOS_THROW(sysio::chain::invalid_http_request, "Unrecognized fields in account");
      }
   }
}

FC_REFLECT( sysio::chain_apis::account_query_db::get_accounts_by_authorizers_params, (accounts)(keys))
FC_REFLECT( sysio::chain_apis::account_query_db::get_accounts_by_authorizers_result::account_result, (account_name)(permission_name)(authorizing_account)(authorizing_key)(weight)(threshold))
FC_REFLECT( sysio::chain_apis::account_query_db::get_accounts_by_authorizers_result, (accounts))
