...
namespace sysio::chain_apis {
   ...
   public:
       ...
       */
      explicit tracked_votes(const class sysio::chain::controller& chain);
      ~tracked_votes();
...
FC_REFLECT( sysio::chain_apis::tracked_votes::vote_info, (description)(public_key)(is_vote_strong)(finalizer_policy_generation)(voted_for_block_id)(voted_for_block_num)(voted_for_block_timestamp))
