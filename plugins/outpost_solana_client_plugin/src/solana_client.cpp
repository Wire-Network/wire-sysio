...
solana_client::solana_client(const std::string& node_url, network_adapter& net_adapter)
    : node_url_(node_url), net_adapter_(net_adapter) {}  // Correct initialization list

std::optional<std::string> solana_client::execute(const std::string& method, const Json::Value& params) {
    Json::Value payload;
    payload["jsonrpc"] = "2.0";
...
std::optional<Json::Value> solana_client::parse_json_response(const std::string& response) {
...
void solana_client::process_result(const Json::Value& result_json) {
...
std::optional<std::string> solana_client::get_transaction_count(const std::string& address) {
   Json::Value params;
    params[0] = address;
...
std::optional<std::string> solana_client::get_chain_id() {
   Json::Value params;
    auto response = execute("eth_chainId", params);
    return response;
}

std::optional<std::string> solana_client::get_network_version() {
   Json::Value params; // Empty params array
    auto response = execute("net_version", params);
    return response;
}

std::optional<std::string> solana_client::get_syncing_status() {
   Json::Value params;
    auto response = execute("eth_syncing", params);
    return response;
}

std::optional<std::string> solana_client::get_block_number() {
   Json::Value params;
    auto response = execute("eth_blockNumber", params);
    return response;
}

std::optional<Json::Value> solana_client::get_block_by_number(const std::string& blockNumber,
...
std::optional<Json::Value> solana_client::get_block_by_hash(const std::string& block_hash, bool full_transaction_data) {
    Json::Value params;
    params[0] = block_hash;
...
std::optional<Json::Value> solana_client::get_transaction_by_hash(const std::string& tx_hash) {
    Json::Value params;
    params[0] = tx_hash;
...
std::optional<std::string> solana_client::estimate_gas(const std::string& from, const std::string& to, const std::string& value) {
    Json::Value params;
    Json::Value tx_data;
    tx_data["from"] = from;
    tx_data["to"] = to;
...
std::optional<std::string> solana_client::get_gas_price() {
    Json::Value params;
    auto        response = execute("eth_gasPrice", params);
    return response;
}

std::optional<std::string> solana_client::send_transaction(const std::string& raw_tx_data) {
    Json::Value params;
...
std::optional<Json::Value> solana_client::get_logs(const Json::Value& params) {
...
std::optional<Json::Value> solana_client::get_transaction_receipt(const std::string& tx_hash) {
    Json::Value params;
    params[0] = tx_hash;
