...
FC_REFLECT(sysio::trace_api::action_trace_v0, (global_sequence)(receiver)(account)(action)(authorization)(data))
FC_REFLECT_DERIVED(sysio::trace_api::action_trace_v1, (sysio::trace_api::action_trace_v0),(return_value))
FC_REFLECT(sysio::trace_api::transaction_trace_v0, (id)(actions))
FC_REFLECT_DERIVED(sysio::trace_api::transaction_trace_v1, (sysio::trace_api::transaction_trace_v0), (status)(cpu_usage_us)(net_usage_words)(signatures)(trx_header))
FC_REFLECT(sysio::trace_api::transaction_trace_v2, (id)(actions)(status)(cpu_usage_us)(net_usage_words)(signatures)(trx_header))
FC_REFLECT_DERIVED(sysio::trace_api::transaction_trace_v3, (sysio::trace_api::transaction_trace_v2), (block_num)(block_time)(producer_block_id))
FC_REFLECT(sysio::trace_api::block_trace_v0, (id)(number)(previous_id)(timestamp)(producer)(transactions))
FC_REFLECT_DERIVED(sysio::trace_api::block_trace_v1, (sysio::trace_api::block_trace_v0), (transaction_mroot)(action_mroot)(schedule_version)(transactions_v1))
FC_REFLECT(sysio::trace_api::block_trace_v2, (id)(number)(previous_id)(timestamp)(producer)(transaction_mroot)(action_mroot)(schedule_version)(transactions))
