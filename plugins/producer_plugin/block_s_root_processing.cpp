...
namespace sysio::chain_apis {
   ...
   struct block_s_root_processing_impl {
      ...
      uint32_t                                         _last_proc_block_num = no_block_num;
   ...
   block_s_root_processing::block_s_root_processing( uint64_t max_storage, const fc::microseconds& success_duration, const fc::microseconds& failure_duration )
   : _my(new block_s_root_processing_impl(max_storage, success_duration, failure_duration))
   {
   }
   ...
   block_s_root_processing::chain_state block_s_root_processing::get_chain_state() const {
   ...
   size_t block_s_root_processing::get_storage_memory_size() const {
      return _my->_storage.memory_size();
   }

   void block_s_root_processing_impl::determine_earliest_tracked_block_id() {
      const auto& indx = _storage.index().get<by_status_expiry>();
