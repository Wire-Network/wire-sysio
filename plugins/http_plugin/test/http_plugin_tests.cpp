...
BOOST_AUTO_TEST_CASE( make_trimmed_string_view ) try {
   ...
   {  // space on the head/tail and body only
      ...
      BOOST_CHECK_EQUAL(sysio::make_trimmed_string_view(str_no_space_both_side), str_no_space_both_side);

      const std::string str_with_leading_space = " " + str_no_space_both_side;
      BOOST_REQUIRE(!str_with_leading_space.empty());
      BOOST_CHECK_EQUAL(sysio::make_trimmed_string_view(str_with_leading_space), str_no_space_both_side);

      const std::string str_with_with_trailing_space = str_no_space_both_side + " ";
      BOOST_REQUIRE(!str_with_with_trailing_space.empty());
      BOOST_CHECK_EQUAL(sysio::make_trimmed_string_view(str_with_with_trailing_space), str_no_space_both_side);

      const std::string str_with_with_space_both_side = " " + str_no_space_both_side + " ";
      BOOST_REQUIRE(!str_with_with_space_both_side.empty());
      BOOST_CHECK_EQUAL(sysio::make_trimmed_string_view(str_with_with_space_both_side), str_no_space_both_side);
   }
} FC_LOG_AND_RETHROW()
...
BOOST_AUTO_TEST_CASE( is_empty_content ) try {
   {  // empty string
      const std::string empty_str;
      BOOST_REQUIRE(empty_str.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_str) == true);
   }
   {  // empty content string
      const std::string empty_content_str_1 = "{}";
      BOOST_REQUIRE(!empty_content_str_1.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_1) == true);
      const std::string empty_content_str_2 = "{ }";
      BOOST_REQUIRE(!empty_content_str_2.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_2) == true);
      const std::string empty_content_str_3 = "{ \t}";
      BOOST_REQUIRE(!empty_content_str_3.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_3) == true);
      const std::string empty_content_str_4 = " { }";
      BOOST_REQUIRE(!empty_content_str_4.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_4) == true);
      const std::string empty_content_str_5 = "{ } ";
      BOOST_REQUIRE(!empty_content_str_5.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_5) == true);
      const std::string empty_content_str_6 = " { } ";
      BOOST_REQUIRE(!empty_content_str_6.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_6) == true);
   }
   {  // one char string
      const std::string one_char_str_1 = "{";
      BOOST_REQUIRE(!one_char_str_1.empty());
      BOOST_REQUIRE(sysio::is_empty_content(one_char_str_1) == false) ;
      const std::string one_char_str_2 = "}";
      BOOST_REQUIRE(!one_char_str_2.empty());
      BOOST_REQUIRE(sysio::is_empty_content(one_char_str_2) == false) ;
      const std::string one_char_str_3 = " ";
      BOOST_REQUIRE(!one_char_str_3.empty());
      BOOST_REQUIRE(sysio::is_empty_content(one_char_str_3) == true) ;
   }
   {  // some content string
      const std::string empty_content_str_1 = "{a}";
      BOOST_REQUIRE(!empty_content_str_1.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_1) == false);
      const std::string empty_content_str_2 = "{\'\'}";
      BOOST_REQUIRE(!empty_content_str_2.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_2) == false);
      const std::string empty_content_str_3 = "{\" \"}";
      BOOST_REQUIRE(!empty_content_str_3.empty());
      BOOST_REQUIRE(sysio::is_empty_content(empty_content_str_3) == false);
   }
   {  // invalid string
      const std::string invalid_str_1 = "{  a";
      BOOST_REQUIRE(!invalid_str_1.empty());
      BOOST_REQUIRE(sysio::is_empty_content(invalid_str_1) == false);
      const std::string invalid_str_2 = " a }";
      BOOST_REQUIRE(!invalid_str_2.empty());
      BOOST_REQUIRE(sysio::is_empty_content(invalid_str_2) == false);
      const std::string invalid_str_3 =  " {a}";
      BOOST_REQUIRE(!invalid_str_3.empty());
      BOOST_REQUIRE(sysio::is_empty_content(invalid_str_3) == false);
      const std::string invalid_str_4 =  "{a} ";
      BOOST_REQUIRE(!invalid_str_4.empty());
      BOOST_REQUIRE(sysio::is_empty_content(invalid_str_4 ) == false);
   }
} FC_LOG_AND_RETHROW()
