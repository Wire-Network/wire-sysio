...
// binary (the plugin's own, AWS-free tests). The kms/ssm suites live in their
// own binaries under plugins/signature_provider_{kms,ssm}_plugin/test/, each
// with its own entry TU: BOOST_TEST_MODULE must be defined in exactly one TU
// per binary.
