   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         ordered_non_unique< tag<by_peer_block_id>,
               composite_key< peer_block_state,
                     member<peer_block_state, block_id_type, &sysio::peer_block_state::id>,
                     member<peer_block_state, bool, &sysio::peer_block_state::have_block>
               >,
               composite_key_compare< sha256_less, std::greater<bool> >
         >,
         ordered_non_unique< tag<by_block_num>, member<sysio::peer_block_state, uint32_t, &sysio::peer_block_state::block_num > >
      >
...
#pragma GCC diagnostic ignored "-Wunused-variable"
   ...
   constexpr uint16_t proto_wire_sysio_initial = 7;            // wire_sysio client, needed because none of the 2.1 versions are supported
