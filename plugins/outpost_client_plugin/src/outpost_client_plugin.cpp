...
namespace sysio {
  ...
  namespace {
    inline fc::logger& logger() {
      static fc::logger log{ "outpost_client_plugin" };
      return log;
    }
  }


  void outpost_client_plugin::plugin_initialize(const variables_map& options) {

  }


  void outpost_client_plugin::plugin_startup() {
  ...
  void outpost_client_plugin::set_program_options(options_description& cli, options_description& cfg) {
  }


  void outpost_client_plugin::plugin_shutdown() {
