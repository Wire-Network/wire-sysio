...
\DoxyCodeLine{00618\ \ \ \ \ \ \ std::set<bfs::path>\ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}};}
\DoxyCodeLine{00619\ \ \ \ \ \ \ BOOST\_REQUIRE(!sd.find\_or\_create\_index\_slice(0,\ open\_state::read,\ file));}
\DoxyCodeLine{00620\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(file.get\_file\_path().filename());}
...
\DoxyCodeLine{00623\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(file.get\_file\_path().filename());}
\DoxyCodeLine{00624\ \ \ \ \ \ \ BOOST\_REQUIRE(!sd.find\_or\_create\_index\_slice(1,\ open\_state::read,\ file));}
\DoxyCodeLine{00625\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(file.get\_file\_path().filename());}
\DoxyCodeLine{00626\ \ \ \ \ \ \ BOOST\_REQUIRE(!sd.find\_or\_create\_trace\_slice(2,\ open\_state::read,\ file));}
\DoxyCodeLine{00627\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(file.get\_file\_path().filename());}
\DoxyCodeLine{00628\ \ \ \ \ \ \ BOOST\_REQUIRE(!sd.find\_or\_create\_index\_slice(3,\ open\_state::read,\ file));}
\DoxyCodeLine{00629\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(file.get\_file\_path().filename());}
...
\DoxyCodeLine{00632\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(index4);}
...
\DoxyCodeLine{00635\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(trace4);}
...
\DoxyCodeLine{00638\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(index5);}
...
\DoxyCodeLine{00641\ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(trace6);}
...
\DoxyCodeLine{00697\ \ \ \ \ \ \ std::set<bfs::path>\ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}};}
\DoxyCodeLine{00698\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ e:\ file\_paths)\ \{}
\DoxyCodeLine{00699\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<0>(e));}
\DoxyCodeLine{00700\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<1>(e));}
\DoxyCodeLine{00701\ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00711\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.erase(std::get<1>(file\_paths.at(reps)));}
\DoxyCodeLine{00712\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<2>(file\_paths.at(reps)));}
\DoxyCodeLine{00713\ }
...
\DoxyCodeLine{00724\ \ \ \ \ \ \ \ \ \ BOOST\_REQUIRE\_EQUAL(\mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.count(std::get<0>(e)),\ 1);}
\DoxyCodeLine{00725\ \ \ \ \ \ \ \ \ \ BOOST\_REQUIRE\_EQUAL(\mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.count(std::get<1>(e)),\ 0);}
\DoxyCodeLine{00726\ \ \ \ \ \ \ \ \ \ BOOST\_REQUIRE\_EQUAL(\mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.count(std::get<2>(e)),\ 1);}
\DoxyCodeLine{00727\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00728\ \ \ \ \}}
...
\DoxyCodeLine{00752\ \ \ \ \ \ \ std::set<bfs::path>\ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}};}
\DoxyCodeLine{00753\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ e:\ file\_paths)\ \{}
\DoxyCodeLine{00754\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<0>(e));}
\DoxyCodeLine{00755\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<1>(e));}
\DoxyCodeLine{00756\ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00767\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.erase(std::get<1>(file\_paths.at(reps)));}
\DoxyCodeLine{00768\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.insert(std::get<2>(file\_paths.at(reps)));}
\DoxyCodeLine{00769\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00770\ }
\DoxyCodeLine{00771\ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ removes\ one\ IF\ its\ not\ the\ first}}
\DoxyCodeLine{00772\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (reps\ >\ 0)\ \{}
\DoxyCodeLine{00773\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.erase(std::get<0>(file\_paths.at(reps-\/1)));}
\DoxyCodeLine{00774\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.erase(std::get<2>(file\_paths.at(reps-\/1)));}
\DoxyCodeLine{00775\ \ \ \ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00785\ \ \ \ \ \ \ BOOST\_REQUIRE\_EQUAL(\mbox{\hyperlink{namespaceapprove_ac74141eb5bed2ad90470ab44a35d0a4f}{files}}.size(),\ 0);}
\DoxyCodeLine{00786\ \ \ \ \}}
...
\DoxyCodeLine{00846\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacedevelop_build_ade64cd34608f9442ef3049116a2da428}{v}}\ =\ std::variant<block\_trace\_v0,\ block\_trace\_v1,\ block\_trace\_v2>(*bt\_data);}
...
\DoxyCodeLine{00939\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacedevelop_build_ade64cd34608f9442ef3049116a2da428}{v}}\ =\ \mbox{\hyperlink{namespacesysio_1_1trace__api_a98bdcc53a9d9aa6aff851a743516c3b9}{data\_log\_entry}}(*bt\_data);}
...
\DoxyCodeLine{00579\ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespaceembed_clara_a1e1bd594f85f58f5dca6c41c0ac720fb}{filename}}\ =\ itr-\/>path().filename();}
