...
\DoxyCodeLine{00427\ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ account\_set\ =\ std::set<chain::permission\_level>(args.accounts.begin(),\ args.accounts.end());}
\DoxyCodeLine{00428\ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ key\_set\ =\ std::set<chain::public\_key\_type>(args.keys.begin(),\ args.keys.end());}
\DoxyCodeLine{00429\ }
