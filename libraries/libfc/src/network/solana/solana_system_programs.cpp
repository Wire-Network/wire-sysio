...
instruction create_account(const solana_public_key& from, const solana_public_key& new_account, uint64_t lamports,
                           uint64_t space, const solana_public_key& owner) {
   borsh::encoder enc;
...
instruction create_account_with_seed(const solana_public_key& from, const solana_public_key& to, const solana_public_key& base,
...
instruction transfer_with_seed(const solana_public_key& from, const solana_public_key& from_base, const std::string& seed,
                               const solana_public_key& from_owner, const solana_public_key& to, uint64_t lamports) {
   borsh::encoder enc;
...
instruction withdraw_nonce(const solana_public_key& nonce_account, const solana_public_key& authority, const solana_public_key& to,
                           uint64_t lamports) {
   borsh::encoder enc;
...
instruction authorize_nonce(const solana_public_key& nonce_account, const solana_public_key& authority, const solana_public_key& new_authority) {
   borsh::encoder enc;
...
//=============================================================================
solana_public_key create_program_address(const std::vector<std::vector<uint8_t>>& seeds, const solana_public_key& program_id) {
...
std::pair<solana_public_key, uint8_t> find_program_address(const std::vector<std::vector<uint8_t>>& seeds,
   ...
   for (int bump = 255; bump >= 0; --bump) {
      ...
      try {
         solana_public_key address = create_program_address(seeds_with_bump, program_id);
