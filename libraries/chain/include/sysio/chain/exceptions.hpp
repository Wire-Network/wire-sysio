...
namespace sysio { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( sysio_assert_message_exception, action_validate_exception,
                                    3050003, "sysio_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( sysio_assert_code_exception, action_validate_exception,
                                    3050004, "sysio_assert_code assertion failure" )
