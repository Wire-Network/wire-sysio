...
CHAINBASE_SET_INDEX_TYPE(sysio::chain::index64_object, sysio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(sysio::chain::index128_object, sysio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(sysio::chain::index256_object, sysio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(sysio::chain::index_double_object, sysio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(sysio::chain::index_long_double_object, sysio::chain::index_long_double_index)

FC_REFLECT(sysio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(sysio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(sysio::chain::index64_object)
REFLECT_SECONDARY(sysio::chain::index128_object)
REFLECT_SECONDARY(sysio::chain::index256_object)
REFLECT_SECONDARY(sysio::chain::index_double_object)
REFLECT_SECONDARY(sysio::chain::index_long_double_object)
