...
CHAINBASE_SET_INDEX_TYPE(sysio::chain::database_header_object, sysio::chain::database_header_multi_index)

FC_REFLECT( sysio::chain::database_header_object, (version) )
