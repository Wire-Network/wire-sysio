...
FC_REFLECT( sysio::chain::finalizer_policy, (generation)(threshold)(finalizers) )
FC_REFLECT( sysio::chain::finalizers_diff_t, (remove_indexes)(insert_indexes) )
FC_REFLECT( sysio::chain::finalizer_policy_diff, (generation)(threshold)(finalizers_diff) )
FC_REFLECT( sysio::chain::finalizer_policy_with_string_key, (generation)(threshold)(finalizers) )
