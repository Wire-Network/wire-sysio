...
namespace std {
   ...
   inline std::ostream& operator<<(std::ostream& os, const sysio::chain::block_ref& br) {
      os << "block_ref(" << br.block_id << ", " << br.timestamp << ", " << br.finality_digest << ", "
         << br.active_policy_generation << ", " << br.pending_policy_generation << ")";
      return os;
   }

   inline std::ostream& operator<<(std::ostream& os, const sysio::chain::qc_link& l) {
      os << "qc_link(" << l.source_block_num << ", " << l.target_block_num << ", " << l.is_link_strong << ")";
      return os;
   }

   inline std::ostream& operator<<(std::ostream& os, const sysio::chain::qc_claim_t& c) {
      os << "qc_claim_t(" << c.block_num << ", " << c.is_strong_qc << ")";
      return os;
   }

   inline std::ostream& operator<<(std::ostream& os, const sysio::chain::core_metadata& cm) {
...
FC_REFLECT( sysio::chain::block_ref, (block_id)(timestamp)(finality_digest)(active_policy_generation)(pending_policy_generation) )
FC_REFLECT( sysio::chain::block_ref_digest_data, (block_num)(timestamp)(finality_digest)(parent_timestamp) )
FC_REFLECT( sysio::chain::qc_link, (source_block_num)(target_block_num)(is_link_strong) )
FC_REFLECT( sysio::chain::qc_claim_t, (block_num)(is_strong_qc) )
FC_REFLECT( sysio::chain::core_metadata, (last_final_block_num)(latest_qc_claim_block_num))
FC_REFLECT( sysio::chain::finality_core, (links)(refs)(genesis_timestamp))
