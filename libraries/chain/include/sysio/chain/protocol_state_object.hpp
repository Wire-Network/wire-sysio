...
CHAINBASE_SET_INDEX_TYPE(sysio::chain::protocol_state_object, sysio::chain::protocol_state_multi_index)

FC_REFLECT(sysio::chain::protocol_state_object::activated_protocol_feature,
            (feature_digest)(activation_block_num)
          )

FC_REFLECT(sysio::chain::protocol_state_object,
            (activated_protocol_features)(preactivated_protocol_features)(whitelisted_intrinsics)(num_supported_key_types)
          )

FC_REFLECT(sysio::chain::snapshot_protocol_state_object,
            (activated_protocol_features)(preactivated_protocol_features)(whitelisted_intrinsics)(num_supported_key_types)
          )
