...
CHAINBASE_SET_INDEX_TYPE(sysio::chain::code_object, sysio::chain::code_index)

FC_REFLECT(sysio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
