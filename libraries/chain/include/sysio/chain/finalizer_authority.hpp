...
FC_REFLECT( sysio::chain::finalizer_authority, (description)(weight)(public_key) )
FC_REFLECT( sysio::chain::finalizer_authority_with_string_key, (description)(weight)(public_key) )
