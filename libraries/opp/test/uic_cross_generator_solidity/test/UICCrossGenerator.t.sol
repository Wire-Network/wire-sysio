...
contract UICCrossGeneratorTest {
    bytes private constant EVM_ADDRESS = hex"9965507d1a55bcc2695c58ba16fb37d819b0a4dc";
    ...
    bytes private constant SVM_ADDRESS = hex"17cb79fb2b4120f2b1ec65e4198d6e08b28e813feb01e4a400839b85e18080ce";
    ...
    function testGeneratedSolidityEncoderMatchesSealedEvmVector() public pure {
        _assertConstructsAndReencodes(ChainKindLib.CHAIN_KIND_EVM, EVM_ADDRESS, EVM_SIGNATURE, EVM_FULL);
    }
    ...
    function decodeAndReencode(bytes memory encoded) external pure returns (bytes memory) {
        return UnderwriteIntentCommitCodec.encode(UnderwriteIntentCommitCodec.decode(encoded));
    }
