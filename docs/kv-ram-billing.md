...
| `kv_index_object` | 8 id + 8 code + 8 table + 1 index_id + 2 sec_key_size + 24 sec_key_inline + 12 sec_key_heap + 2 pri_key_size + 24 pri_key_inline + 12 pri_key_heap + padding = ~93 | 3 | 96 | **189** + sec_key_size + pri_key_size |
...
| `kv_index_object` (189 + 8 sec_key + 16 pri_key) | 213 |
| **Total per row** | **397** |

### Difference: +37 bytes per row (+10%)
