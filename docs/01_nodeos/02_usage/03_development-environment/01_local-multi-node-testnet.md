...
```sh
cleos --wallet-url http://127.0.0.1:8899 create account sysio inita SYS6hMjoWRF2L8x9YpeqtUEcsDKAyxSuM1APicxgRU1E3oyV5sDEg SYS6hMjoWRF2L8x9YpeqtUEcsDKAyxSuM1APicxgRU1E3oyV5sDEg
```
...
```sh
cleos --wallet-url http://127.0.0.1:8899 push action sysio setprods "{ \"schedule\": [{\"producer_name\": \"inita\",\"block_signing_key\": \"SYS6hMjoWRF2L8x9YpeqtUEcsDKAyxSuM1APicxgRU1E3oyV5sDEg\"}]}" -p sysio@active
```
