...
The example in this how-to guide creates a new account named **bob**, authorized by the default system account **sysio**, using the `cleos` CLI tool.
...
```sh
cleos create account sysio bob SYS87TQktA5RVse2EguhztfQVEh6XXxBmgkU8b4Y5YnGvtYAoLGNN
```
**Where**:
