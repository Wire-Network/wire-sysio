...
read -d '' genesis << EOF
{
  ...
  "initial_key": "SYS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
private-key = ['SYS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/sysio-launcher/sysio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
programs/sysio-launcher/sysio-launcher -k 15
rm -rf staging
rm -rf var/lib/node_*
rm -rf etc/sysio/node_*
exit $ret
