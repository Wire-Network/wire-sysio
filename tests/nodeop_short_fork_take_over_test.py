...
#
# Similar scenario to nodeop_forked_chain_test, except that there are only 3 producers and, after the "bridge" node is
...
try:
    ...
    specificExtraNodeopArgs[totalProducerNodes]="--plugin eosio::test_control_api_plugin"
    ...
    if cluster.launch(prodCount=2, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      specificExtraNodeopArgs=specificExtraNodeopArgs, extraNodeopArgs=extraNodeopArgs, onlySetProds=True) is False:
