...
class WalletMgr(object):
    __walletLogOutFile="var/test_kiod_out.log"
    __walletLogErrFile="var/test_kiod_err.log"
    ...
    def __init__(self, walletd, nodeopPort=8888, nodeopHost="localhost", port=9899, host="localhost"):
