...
class P2PTestPeers:
    ...
    ports = [8888] # sysiod listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # sysiod listening port of each host
