...
#  - Start nodeop in irreversible mode on blocklog
...
try:
    ...
    cluster.launchTrxGenerators(contractOwnerAcctName=cluster.sysioAccount.name, acctNamesList=[account1Name, account2Name],
