...
static const sysio::chain::abi_serializer::yield_function_t null_yield_function{};

int main(int argc, char* argv[]) {
   boost::asio::io_context ctx;
   boost::asio::ip::tcp::resolver resolver(ctx);
   boost::beast::websocket::stream<boost::asio::ip::tcp::socket> stream(ctx);
   sysio::chain::abi_serializer abi;
   ...
   try {
...

      {
         ...
         abi = sysio::chain::abi_serializer(fc::json::from_string(abi_string).as<sysio::chain::abi_def>(), null_yield_function);
         ...
         abi.add_specialized_unpack_pack("bytes", std::make_pair<sysio::chain::abi_serializer::unpack_function, sysio::chain::abi_serializer::pack_function>(
            [](fc::datastream<const char*>& stream, bool is_array, bool is_optional, const sysio::chain::abi_serializer::yield_function_t& yield) {
         ...
         [](const fc::variant&, fc::datastream<char*>&, bool, bool, const sysio::chain::abi_serializer::yield_function_t&) {
      ...
      stream.binary(true);
      const sysio::chain::bytes get_status_bytes = abi.variant_to_binary("request",
