...
echo Launcher options: --nodeos \"--plugin sysio::wallet_api_plugin\" $launcherOpts
programs/sysio-launcher/sysio-launcher --nodeos "--plugin sysio::wallet_api_plugin" $launcherOpts
sleep 7
