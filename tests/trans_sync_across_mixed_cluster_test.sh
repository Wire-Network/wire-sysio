...
# stand up nodeop cluster
launcherOpts="-p $pnodes -n $total_nodes -s $topo -d $delay"
echo Launcher options: --nodeop \"--plugin sysio::wallet_api_plugin\" $launcherOpts
programs/sysio-launcher/sysio-launcher --nodeop "--plugin sysio::wallet_api_plugin" $launcherOpts
sleep 7
