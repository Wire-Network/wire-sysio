...
\DoxyCodeLine{03599\ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacesysio_a4f30e0f4812705f23bf9b5bbd3eba7fc}{peer\_log\_format}}\ =\ options.at(\ \textcolor{stringliteral}{"{}peer-\/log-\/format"{}}\ ).as<\textcolor{keywordtype}{string}>();}
\DoxyCodeLine{03600\ }
\DoxyCodeLine{03601\ \ \ \ \ \ \ \ \ \ my-\/>sync\_master.reset(\ \textcolor{keyword}{new}\ sync\_manager(\ options.at(\ \textcolor{stringliteral}{"{}sync-\/fetch-\/span"{}}\ ).as<\mbox{\hyperlink{stdint_8h_a435d1572bf3f880d55459d9805097f62}{uint32\_t}}>()));}
\DoxyCodeLine{03602\ }
\DoxyCodeLine{03603\ \ \ \ \ \ \ \ \ \ my-\/>connector\_period\ =\ std::chrono::seconds(\ options.at(\ \textcolor{stringliteral}{"{}connection-\/cleanup-\/period"{}}\ ).as<\textcolor{keywordtype}{int}>());}
\DoxyCodeLine{03604\ \ \ \ \ \ \ \ \ \ my-\/>max\_cleanup\_time\_ms\ =\ options.at(\textcolor{stringliteral}{"{}max-\/cleanup-\/time-\/msec"{}}).as<\textcolor{keywordtype}{int}>();}
...
\DoxyCodeLine{03606\ \ \ \ \ \ \ \ \ \ my-\/>p2p\_dedup\_cache\_expire\_time\_us\ =\ \mbox{\hyperlink{namespacefc_a9623b8cae3f48bbed6aa1fc2afe9b174}{fc::seconds}}(\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/dedup-\/cache-\/expire-\/time-\/sec"{}}\ ).as<\mbox{\hyperlink{stdint_8h_a435d1572bf3f880d55459d9805097f62}{uint32\_t}}>()\ );}
...
\DoxyCodeLine{03608\ \ \ \ \ \ \ \ \ \ my-\/>max\_client\_count\ =\ options.at(\ \textcolor{stringliteral}{"{}max-\/clients"{}}\ ).as<\textcolor{keywordtype}{int}>();}
\DoxyCodeLine{03609\ \ \ \ \ \ \ \ \ \ my-\/>max\_nodes\_per\_host\ =\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/max-\/nodes-\/per-\/host"{}}\ ).as<\textcolor{keywordtype}{int}>();}
\DoxyCodeLine{03610\ \ \ \ \ \ \ \ \ \ my-\/>p2p\_accept\_transactions\ =\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/accept-\/transactions"{}}\ ).as<\textcolor{keywordtype}{bool}>();}
\DoxyCodeLine{03611\ }
\DoxyCodeLine{03612\ \ \ \ \ \ \ \ \ \ my-\/>use\_socket\_read\_watermark\ =\ options.at(\ \textcolor{stringliteral}{"{}use-\/socket-\/read-\/watermark"{}}\ ).as<\textcolor{keywordtype}{bool}>();}
\DoxyCodeLine{03613\ \ \ \ \ \ \ \ \ \ my-\/>keepalive\_interval\ =\ std::chrono::milliseconds(\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/keepalive-\/interval-\/ms"{}}\ ).as<\textcolor{keywordtype}{int}>()\ );}
...
\DoxyCodeLine{03616\ }
\DoxyCodeLine{03617\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}p2p-\/keepalive-\/interval-\/ms"{}}\ ))\ \{}
\DoxyCodeLine{03618\ \ \ \ \ \ \ \ \ \ \ \ \ my-\/>heartbeat\_timeout\ =\ std::chrono::milliseconds(\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/keepalive-\/interval-\/ms"{}}\ ).as<\textcolor{keywordtype}{int}>()\ *\ 2\ );}
\DoxyCodeLine{03619\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03620\ }
\DoxyCodeLine{03621\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}p2p-\/listen-\/endpoint"{}}\ )\ \&\&\ options.at(\textcolor{stringliteral}{"{}p2p-\/listen-\/endpoint"{}}).as<\textcolor{keywordtype}{string}>().length())\ \{}
\DoxyCodeLine{03622\ \ \ \ \ \ \ \ \ \ \ \ \ my-\/>p2p\_address\ =\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/listen-\/endpoint"{}}\ ).as<\textcolor{keywordtype}{string}>();}
...
\DoxyCodeLine{03625\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03626\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}p2p-\/server-\/address"{}}\ )\ )\ \{}
\DoxyCodeLine{03627\ \ \ \ \ \ \ \ \ \ \ \ \ my-\/>p2p\_server\_address\ =\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/server-\/address"{}}\ ).as<\textcolor{keywordtype}{string}>();}
...
\DoxyCodeLine{03630\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03631\ }
\DoxyCodeLine{03632\ \ \ \ \ \ \ \ \ \ my-\/>thread\_pool\_size\ =\ options.at(\ \textcolor{stringliteral}{"{}net-\/threads"{}}\ ).as<\mbox{\hyperlink{stdint_8h_a273cf69d639a59973b6019625df33e30}{uint16\_t}}>();}
...
\DoxyCodeLine{03635\ }
\DoxyCodeLine{03636\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}p2p-\/peer-\/address"{}}\ ))\ \{}
\DoxyCodeLine{03637\ \ \ \ \ \ \ \ \ \ \ \ \ my-\/>supplied\_peers\ =\ options.at(\ \textcolor{stringliteral}{"{}p2p-\/peer-\/address"{}}\ ).as<\mbox{\hyperlink{classfc_1_1vector}{vector<string>}}\ >();}
\DoxyCodeLine{03638\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03639\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}agent-\/name"{}}\ ))\ \{}
\DoxyCodeLine{03640\ \ \ \ \ \ \ \ \ \ \ \ \ my-\/>user\_agent\_name\ =\ options.at(\ \textcolor{stringliteral}{"{}agent-\/name"{}}\ ).as<\textcolor{keywordtype}{string}>();}
...
\DoxyCodeLine{03643\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03644\ }
\DoxyCodeLine{03645\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}allowed-\/connection"{}}\ ))\ \{}
\DoxyCodeLine{03646\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::vector<std::string>\ allowed\_remotes\ =\ options[\textcolor{stringliteral}{"{}allowed-\/connection"{}}].as<std::vector<std::string>>();}
...
\DoxyCodeLine{03660\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{chain_2include_2sysio_2chain_2exceptions_8hpp_a40c2826a6fba35c1ffbf912bdf559792}{SYS\_ASSERT}}(\ options.count(\ \textcolor{stringliteral}{"{}peer-\/key"{}}\ ),}
...
\DoxyCodeLine{03663\ }
\DoxyCodeLine{03664\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}peer-\/key"{}}\ ))\ \{}
\DoxyCodeLine{03665\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::vector<std::string>\ key\_strings\ =\ options[\textcolor{stringliteral}{"{}peer-\/key"{}}].as<std::vector<std::string>>();}
...
\DoxyCodeLine{03669\ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{03670\ }
\DoxyCodeLine{03671\ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ options.count(\ \textcolor{stringliteral}{"{}peer-\/private-\/key"{}}\ ))\ \{}
\DoxyCodeLine{03672\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::vector<std::string>\ key\_id\_to\_wif\_pair\_strings\ =\ options[\textcolor{stringliteral}{"{}peer-\/private-\/key"{}}].as<std::vector<std::string>>();}
