\chapter{SAX}
\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax}{}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax}\index{SAX@{SAX}}
The term "{}\+SAX"{} originated from \href{http://en.wikipedia.org/wiki/Simple_API_for_XML}{\texttt{ Simple API for XML}}. We borrowed this term for JSON parsing and generation.

In Rapid\+JSON, {\ttfamily Reader} (typedef of {\ttfamily \doxylink{class_generic_reader}{Generic\+Reader}\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}}) is the SAX-\/style parser for JSON, and {\ttfamily \doxylink{class_writer}{Writer}} (typedef of {\ttfamily Generic\+Writer\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}}) is the SAX-\/style generator for JSON.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Reader}{}\doxysection{\texorpdfstring{Reader}{Reader}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Reader}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}String("{}}\ <<\ \mbox{\hyperlink{namespace_c_l_i_1_1detail_ab4542375c903302c3876ce0403d55596}{str}}\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ length\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ boolalpha\ <<\ \mbox{\hyperlink{namespacefc_a79771837fffd80fcc4bc658ee2fc4b2b}{copy}}\ <<\ \textcolor{stringliteral}{"{})"{}}\ <<\ endl;}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ cout\ <<\ \textcolor{stringliteral}{"{}Key("{}}\ <<\ \mbox{\hyperlink{namespace_c_l_i_1_1detail_ab4542375c903302c3876ce0403d55596}{str}}\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ length\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ boolalpha\ <<\ \mbox{\hyperlink{namespacefc_a79771837fffd80fcc4bc658ee2fc4b2b}{copy}}\ <<\ \textcolor{stringliteral}{"{})"{}}\ <<\ endl;}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};}
\DoxyCodeLine{\ \ \ \ \}}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{platform__timer__posix__test_8c_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}()\ \{}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{struct_generic_string_stream}{StringStream}}\ \mbox{\hyperlink{namespace_xbyak_1_1util_a67cd5471fb751b186b53fdab6da7d3f7}{ss}}(json);}
...
Note that Rapid\+JSON uses templates to statically bind the {\ttfamily Reader} type and the handler type, instead of using classes with virtual functions. This paradigm can improve performance by inlining functions.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Handler}{}\doxysubsection{\texorpdfstring{Handler}{Handler}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Handler}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{struct_bool}{Bool}}(\textcolor{keywordtype}{bool}\ b);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacefc_1_1raw_a9aa92d9373bd4df708101483c4edd662}{Int}}(\textcolor{keywordtype}{int}\ i);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ Uint(\textcolor{keywordtype}{unsigned}\ i);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacetesting_1_1internal_a271c563fec38b804ddab0677f51f70a8}{Int64}}(\mbox{\hyperlink{stdint_8h_a414156feea104f8f75b4ed9e3121b2f6}{int64\_t}}\ i);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ Uint64(\mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}}\ i);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespacetesting_1_1internal_a66a7579b1893b260c31dad577f7a5c48}{Double}}(\textcolor{keywordtype}{double}\ d);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ RawNumber(\textcolor{keyword}{const}\ \mbox{\hyperlink{hash__impl_8h_ab0a0d1ad13c7e4d3cb38c89f7127c85a}{Ch}}*\ str,\ \mbox{\hyperlink{rapidjson_8h_a5ed6e6e67250fadbd041127e6386dcb5}{SizeType}}\ length,\ \textcolor{keywordtype}{bool}\ copy);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ String(\textcolor{keyword}{const}\ \mbox{\hyperlink{hash__impl_8h_ab0a0d1ad13c7e4d3cb38c89f7127c85a}{Ch}}*\ str,\ \mbox{\hyperlink{rapidjson_8h_a5ed6e6e67250fadbd041127e6386dcb5}{SizeType}}\ length,\ \textcolor{keywordtype}{bool}\ copy);}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ StartObject();}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ Key(\textcolor{keyword}{const}\ \mbox{\hyperlink{hash__impl_8h_ab0a0d1ad13c7e4d3cb38c89f7127c85a}{Ch}}*\ str,\ \mbox{\hyperlink{rapidjson_8h_a5ed6e6e67250fadbd041127e6386dcb5}{SizeType}}\ length,\ \textcolor{keywordtype}{bool}\ copy);}
...
{\ttfamily \doxylink{struct_bool}{Bool(bool)}} is called when the {\ttfamily Reader} encounters a JSON true or false value.
...
For example, when we parse a JSON with {\ttfamily Reader} and the handler detects that the JSON does not conform to the required schema, the handler can return {\ttfamily false} and let the {\ttfamily Reader} stop further parsing. This will place the {\ttfamily Reader} in an error state, with error code {\ttfamily k\+Parse\+Error\+Termination}.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_GenericReader}{}\doxysubsection{\texorpdfstring{Generic\+Reader}{Generic\+Reader}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_GenericReader}
As mentioned before, {\ttfamily Reader} is a typedef of a template class {\ttfamily \doxylink{class_generic_reader}{Generic\+Reader}}\+:
...
Note that, the default character type of {\ttfamily \doxylink{struct_u_t_f16}{UTF16}} is {\ttfamily wchar\+\_\+t}. So this {\ttfamily reader} needs to call {\ttfamily String(const wchar\+\_\+t\texorpdfstring{$\ast$}{*}, Size\+Type, bool)} of the handler.

The third template parameter {\ttfamily Allocator} is the allocator type for internal data structure (actually a stack).\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2schema_8zh-cn_SaxParsing}{}\doxysubsection{\texorpdfstring{Parsing}{Parsing}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2schema_8zh-cn_SaxParsing}
...
If an error occurs during parsing, it will return {\ttfamily false}. User can also call {\ttfamily bool Has\+Parse\+Error()}, {\ttfamily Parse\+Error\+Code Get\+Parse\+Error\+Code()} and {\ttfamily size\+\_\+t Get\+Error\+Offset()} to obtain the error states. In fact, {\ttfamily Document} uses these {\ttfamily Reader} functions to obtain parse errors. Please refer to \doxylink{dom_8md}{DOM} for details about parse errors.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_TokenByTokenParsing}{}\doxysubsection{\texorpdfstring{Token-\/by-\/\+Token Parsing}{Token-\/by-\/\+Token Parsing}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_TokenByTokenParsing}
...
\end{DoxyCode}
\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Writer}{}\doxysection{\texorpdfstring{Writer}{Writer}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Writer}
{\ttfamily Reader} converts (parses) JSON into events. {\ttfamily \doxylink{class_writer}{Writer}} does exactly the opposite. It converts events into JSON.

{\ttfamily \doxylink{class_writer}{Writer}} is very easy to use. If your application only need to converts some data into JSON, it may be a good choice to use {\ttfamily \doxylink{class_writer}{Writer}} directly, instead of building a {\ttfamily Document} and then stringifying it with a {\ttfamily \doxylink{class_writer}{Writer}}.
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{platform__timer__posix__test_8c_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}()\ \{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{class_generic_string_buffer}{StringBuffer}}\ \mbox{\hyperlink{yubihsm__pkcs11_8c_a506da415c9307c897ca9be93acfe1d0f}{s}};}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{class_writer}{Writer<StringBuffer>}}\ writer(\mbox{\hyperlink{yubihsm__pkcs11_8c_a506da415c9307c897ca9be93acfe1d0f}{s}});}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ cout\ <<\ \mbox{\hyperlink{yubihsm__pkcs11_8c_a506da415c9307c897ca9be93acfe1d0f}{s}}.GetString()\ <<\ endl;}
\DoxyCodeLine{\}}
...
Note that, the example code does not pass any parameters in {\ttfamily End\+Array()} and {\ttfamily End\+Object()}. An {\ttfamily Size\+Type} can be passed but it will be simply ignored by {\ttfamily \doxylink{class_writer}{Writer}}.

You may doubt that, why not just using {\ttfamily sprintf()} or {\ttfamily std\+::stringstream} to build a JSON?

There are various reasons\+:
\begin{DoxyEnumerate}
\item {\ttfamily \doxylink{class_writer}{Writer}} must output a well-\/formed JSON. If there is incorrect event sequence (e.\+g. {\ttfamily Int()} just after {\ttfamily Start\+Object()}), it generates assertion fail in debug mode.
\item {\ttfamily \doxylink{class_writer_a8b4dc44f471403a83c9959575796ceab}{Writer\+::\+String()}} can handle string escaping (e.\+g. converting code point {\ttfamily U+000A} to {\ttfamily \textbackslash{}n}) and Unicode transcoding.
\item {\ttfamily \doxylink{class_writer}{Writer}} handles number output consistently.
\item {\ttfamily \doxylink{class_writer}{Writer}} implements the event handler concept. It can be used to handle events from {\ttfamily Reader}, {\ttfamily Document} or other event publisher.
\item {\ttfamily \doxylink{class_writer}{Writer}} can be optimized for different platforms.
\end{DoxyEnumerate}

Anyway, using {\ttfamily \doxylink{class_writer}{Writer}} API is even simpler than generating a JSON by ad hoc methods.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_WriterTemplate}{}\doxysubsection{\texorpdfstring{Template}{Template}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_WriterTemplate}
{\ttfamily \doxylink{class_writer}{Writer}} has a minor design difference to {\ttfamily Reader}. {\ttfamily \doxylink{class_writer}{Writer}} is a template class, not a typedef. There is no {\ttfamily Generic\+Writer}. The following is the declaration.
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{class_writer}{Writer}}(OutputStream\&\ \mbox{\hyperlink{environment_8hpp_a3951483d0b31c29ca95336206cd35238}{os}},\ \mbox{\hyperlink{classrapidjson_1_1_allocator}{Allocator}}*\ allocator\ =\ 0,\ \textcolor{keywordtype}{size\_t}\ levelDepth\ =\ kDefaultLevelDepth)}
\DoxyCodeLine{\textcolor{comment}{//\ ...}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\}\ \textcolor{comment}{//\ namespace\ rapidjson}}
...
The {\ttfamily Source\+Encoding} template parameter specifies the encoding to be used in {\ttfamily String(const Ch\texorpdfstring{$\ast$}{*}, ...)}.
...
Besides, the constructor of {\ttfamily \doxylink{class_writer}{Writer}} has a {\ttfamily level\+Depth} parameter. This parameter affects the initial memory allocated for storing information per hierarchy level.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_PrettyWriter}{}\doxysubsection{\texorpdfstring{Pretty\+Writer}{Pretty\+Writer}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_PrettyWriter}
While the output of {\ttfamily \doxylink{class_writer}{Writer}} is the most condensed JSON without white-\/spaces, suitable for network transfer or storage, it is not easily readable by human.

Therefore, Rapid\+JSON provides a {\ttfamily \doxylink{class_pretty_writer}{Pretty\+Writer}}, which adds indentation and line feeds in the output.

The usage of {\ttfamily \doxylink{class_pretty_writer}{Pretty\+Writer}} is exactly the same as {\ttfamily \doxylink{class_writer}{Writer}}, expect that {\ttfamily \doxylink{class_pretty_writer}{Pretty\+Writer}} provides a {\ttfamily Set\+Indent(\+Ch indent\+Char, unsigned indent\+Char\+Count)} function. The default is 4 spaces.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_CompletenessReset}{}\doxysubsection{\texorpdfstring{Completeness and Reset}{Completeness and Reset}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_CompletenessReset}
\doxylink{struct_a}{A} {\ttfamily \doxylink{class_writer}{Writer}} can only output a single JSON, which can be any JSON type at the root. Once the singular event for root (e.\+g. {\ttfamily String()}), or the last matching {\ttfamily End\+Object()} or {\ttfamily End\+Array()} event, is handled, the output JSON is well-\/formed and complete. User can detect this state by calling {\ttfamily \doxylink{class_writer_a07d74d36dd3191b06e0aab678c246157}{Writer\+::\+Is\+Complete()}}.

When a JSON is complete, the {\ttfamily \doxylink{class_writer}{Writer}} cannot accept any new events. Otherwise the output will be invalid (i.\+e. having more than one root). To reuse the {\ttfamily \doxylink{class_writer}{Writer}} object, user can call {\ttfamily \doxylink{class_writer_a8b53e8f137f7fcf694f5500711b3f58d}{Writer\+::\+Reset}(Output\+Stream\& os)} to reset all internal states of the {\ttfamily \doxylink{class_writer}{Writer}} with a new output stream.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_SaxTechniques}{}\doxysection{\texorpdfstring{Techniques}{Techniques}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_SaxTechniques}
\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_CustomDataStructure}{}\doxysubsection{\texorpdfstring{Parsing JSON to Custom Data Structure}{Parsing JSON to Custom Data Structure}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_CustomDataStructure}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{enum}\ State\ \{}
...
In the second JSON ({\ttfamily json2}), {\ttfamily foo}\textquotesingle{}s value is an empty object. As it is an object, {\ttfamily \doxylink{struct_message_handler_a3d7e691831748287252e10ced02061f5}{Message\+Handler\+::\+Start\+Object()}} will be called. However, at that moment {\ttfamily state\+\_\+ = k\+Expect\+Value}, so that function returns {\ttfamily false} and cause the parsing process be terminated. The error code is {\ttfamily k\+Parse\+Error\+Termination}.\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Filtering}{}\doxysubsection{\texorpdfstring{Filtering of JSON}{Filtering of JSON}}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2sax_8zh-cn_Filtering}
As mentioned earlier, {\ttfamily \doxylink{class_writer}{Writer}} can handle the events published by {\ttfamily Reader}. {\ttfamily condense} example simply set a {\ttfamily \doxylink{class_writer}{Writer}} as handler of a {\ttfamily Reader}, so it can remove all white-\/spaces in JSON. {\ttfamily pretty} example uses the same relationship, but replacing {\ttfamily \doxylink{class_writer}{Writer}} by {\ttfamily \doxylink{class_pretty_writer}{Pretty\+Writer}}. So {\ttfamily pretty} can be used to reformat a JSON with indentation and line feed.
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{platform__timer__posix__test_8c_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}(\textcolor{keywordtype}{int},\ \textcolor{keywordtype}{char}*[])\ \{}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{class_file_write_stream}{FileWriteStream}}\ \mbox{\hyperlink{environment_8hpp_a3951483d0b31c29ca95336206cd35238}{os}}(stdout,\ writeBuffer,\ \textcolor{keyword}{sizeof}(writeBuffer));}
