...
BOOST_AUTO_TEST_SUITE(sysio_bios_if_tests)

// one finalizer in finalizer policy
BOOST_FIXTURE_TEST_CASE( set_1_finalizer, sysio_bios_if_tester ) try {
   // public_key and pop are generated by sys-util
...
BOOST_FIXTURE_TEST_CASE( set_2_finalizers, sysio_bios_if_tester ) try {
   // public_key and pop are generated by sys-util
   push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()
         ("threshold", 5)
...
BOOST_FIXTURE_TEST_CASE( empty_finalizers, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
         ("finalizers", std::vector<mvo>{}))), sysio_assert_message_exception);
} FC_LOG_AND_RETHROW()

// public_key must start with PUB_BLS
BOOST_FIXTURE_TEST_CASE( public_key_not_started_with_PUB_BLS, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
...
BOOST_FIXTURE_TEST_CASE( signature_not_started_with_SIG_BLS, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
         ("finalizers", std::vector<mvo>{mvo()
            ("description", "set_1_finalizer")
...
BOOST_FIXTURE_TEST_CASE( pop_failed, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
         ("finalizers", std::vector<mvo>{mvo()
            ("description", "set_1_finalizer")
...
BOOST_FIXTURE_TEST_CASE( threshold_equal_to_half_weights, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()
         ("threshold", 5)
         ("finalizers", std::vector<mvo>{
...
BOOST_FIXTURE_TEST_CASE( threshold_greater_than_by_one_half_weights, sysio_bios_if_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( duplicate_pub_keys, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()
         ("threshold", 10)
         ("finalizers", std::vector<mvo>{
...
BOOST_FIXTURE_TEST_CASE( long_description, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
         ("finalizers", std::vector<mvo>{mvo()
...
BOOST_FIXTURE_TEST_CASE( description_size_equal_to_max, sysio_bios_if_tester ) try {
   BOOST_REQUIRE_NO_THROW(push_action("iftester"_n, "setfinalizer"_n, "iftester"_n, mvo()
      ("finalizer_policy", mvo()("threshold", 2)
         ("finalizers", std::vector<mvo>{mvo()
