...
namespace sysio {
   ...
   class [[sysio::contract("sysio.token")]] token : public contract {
      public:
          ...
          *
          * More information can be read [here](https://github.com/SYSIO/sysio.contracts/issues/62)
          * and [here](https://github.com/SYSIO/sysio.contracts/issues/61).
          */
         [[sysio::action]]
      ...
      private:
         ...
         typedef sysio::kv::table< "accounts"_n, account > accounts;
         typedef sysio::kv::table< "stat"_n, currency_stats > stats;
