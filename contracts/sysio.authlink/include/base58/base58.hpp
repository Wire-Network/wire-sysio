...
namespace base58
{
    ...
    inline static bool DecodeBase58(const char* psz, std::vector<unsigned char>& vch)
    {
        // print("Initial: ", psz);
        ...
        sysio::check(sizeof(mapBase58)/sizeof(mapBase58[0]) == 256, "mapBase58.size() should be 256"); // guarantee not out of range
