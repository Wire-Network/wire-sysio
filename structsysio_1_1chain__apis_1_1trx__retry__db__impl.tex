...
\DoxyCodeLine{00143\ \ \ \ \ \ \ \textcolor{keyword}{auto}\&\ idx\ =\ \_tracked\_trxs.\mbox{\hyperlink{classfc_1_1tracked__storage_ab578f3765c80c8cee1d758d440c99e90}{index}}().get<by\_trx\_id>();}
\DoxyCodeLine{00144\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ itr\ =\ idx.find(trace-\/>id);}
\DoxyCodeLine{00145\ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\ itr\ !=\ idx.end()\ )\ \{}
