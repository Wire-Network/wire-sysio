...
\DoxyCodeLine{00025\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!options.count(\textcolor{stringliteral}{"{}s-\/chain-\/contract"{}})\ ||\ !options.count(\textcolor{stringliteral}{"{}s-\/chain-\/actions"{}}))\ \{}
...
\DoxyCodeLine{00029\ \ \ \ \ \ \ \ \ \ std::string\ contract\_name\_str\ =\ options.at(\textcolor{stringliteral}{"{}s-\/chain-\/contract"{}}).as<std::string>();}
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \ \ \ \ \ \ \ \ \ std::vector<std::string>\ actions\ =\ options.at(\textcolor{stringliteral}{"{}s-\/chain-\/actions"{}}).as<std::vector<std::string>>();}
