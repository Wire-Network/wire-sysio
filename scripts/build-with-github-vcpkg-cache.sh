...
Options:
  --build-dir DIR       Developer mode build directory prefix; dev-release
                       uses DIR/release, dev-debug uses
                       DIR/debug-release-deps, dev-asan uses DIR/asan, and
                       dev-ubsan uses DIR/ubsan. CI modes use DIR as the exact
  ...
  cat > "$file" <<PRESETS
{
  ...
  "configurePresets": [
    ...
    {
      "name": "dev-asan",
      "displayName": "Developer ASan with GitHub vcpkg cache release deps",
      "inherits": "dev-release",
      "binaryDir": $asan_build_dir_json,
      "cacheVariables": {
    ...
    {
      "name": "dev-ubsan",
      "displayName": "Developer UBSan with GitHub vcpkg cache release deps",
      "inherits": "dev-release",
      "binaryDir": $ubsan_build_dir_json,
      "cacheVariables": {
        "CMAKE_BUILD_TYPE": "RelWithDebInfo",
        "CMAKE_C_FLAGS": "-fsanitize=undefined -fno-sanitize-recover=all -fno-omit-frame-pointer",
        "CMAKE_CXX_FLAGS": "-fsanitize=undefined -fno-sanitize-recover=all -fno-omit-frame-pointer"
      },
      "environment": {
