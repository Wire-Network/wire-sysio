\chapter{Features}
\hypertarget{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2features}{}\label{md_libraries_2fc_2include_2fc_2crypto_2webauthn__json_2doc_2features}\index{Features@{Features}}
\doxysection*{General}
...
\item Only included {\ttfamily \texorpdfstring{$<$}{<}cstdio\texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}cstdlib\texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}cstring\texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}\doxylink{inttypes_8h}{inttypes.\+h}\texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}new\texorpdfstring{$>$}{>}}, {\ttfamily \texorpdfstring{$<$}{<}\doxylink{stdint_8h}{stdint.\+h}\texorpdfstring{$>$}{>}}.
\end{DoxyItemize}
...
\doxysection*{Standard compliance}


\begin{DoxyItemize}
\item Rapid\+JSON should be fully RFC4627/\+ECMA-\/404 compliance.
\item Support JSON Pointer (RFC6901).
\item Support JSON \doxylink{class_schema}{Schema} Draft v4.
\item Support Unicode surrogate.
\item Support null character ({\ttfamily "{}\textbackslash{}u0000"{}})
\begin{DoxyItemize}
\item For example, {\ttfamily \mbox{[}"{}\+Hello\textbackslash{}u0000\+World"{}\mbox{]}} can be parsed and handled gracefully. There is API for getting/setting lengths of string.
\end{DoxyItemize}
\item Support optional relaxed syntax.
\begin{DoxyItemize}
\item Single line ({\ttfamily // ...}) and multiple line ({\ttfamily /\texorpdfstring{$\ast$}{*} ... \texorpdfstring{$\ast$}{*}/}) comments ({\ttfamily k\+Parse\+Comments\+Flag}).
...
\begin{DoxyItemize}
\item By default the character types are {\ttfamily char} for \doxylink{struct_u_t_f8}{UTF8}, {\ttfamily wchar\+\_\+t} for \doxylink{struct_u_t_f16}{UTF16}, {\ttfamily uint32\+\_\+t} for \doxylink{struct_u_t_f32}{UTF32}.
\end{DoxyItemize}
\item Support custom encodings.
\end{DoxyItemize}

\doxysection*{API styles}
...
\end{DoxyItemize}
\item Optimization for "{}short"{} strings
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item \doxylink{struct_a}{A} stack-\/based allocator (allocate sequentially, prohibit to free individual allocations, suitable for parsing).
