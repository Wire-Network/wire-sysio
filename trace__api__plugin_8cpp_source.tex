...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00228}00228\ \ \ \ \ \ \ \ \ \ shared\_store\_provider<store\_provider>(\mbox{\hyperlink{namespacecommon}{common}}-\/>store),}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00360}00360\ \ \ \ :\mbox{\hyperlink{namespacecommon}{common}}(\mbox{\hyperlink{namespacecommon}{common}})\ \{\}}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00372}00372\ \ \ \ \ \ \ \mbox{\hyperlink{structsysio_1_1trace__api__plugin__impl_af15f7caebc11ee0520b7e19de6f25b7c}{extraction}}\ =\ std::make\_shared<chain\_extraction\_t>(shared\_store\_provider<store\_provider>(\mbox{\hyperlink{namespacecommon}{common}}-\/>store),\ log\_exceptions\_and\_shutdown);}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00407}00407\ \ \ \ \ \ \ \mbox{\hyperlink{namespacecommon}{common}}-\/>plugin\_startup();}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00411}00411\ \ \ \ \ \ \ \mbox{\hyperlink{namespacecommon}{common}}-\/>plugin\_shutdown();}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00438}00438\ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacecommon}{common}}\ =\ std::make\_shared<trace\_api\_common\_impl>();}
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00439}00439\ \ \ \ \mbox{\hyperlink{namespacecommon}{common}}-\/>plugin\_initialize(options);}
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00440}00440\ }
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00441}00441\ \ \ \ my\ =\ std::make\_shared<trace\_api\_plugin\_impl>(\mbox{\hyperlink{namespacecommon}{common}});}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00444}00444\ \ \ \ rpc\ =\ std::make\_shared<trace\_api\_rpc\_plugin\_impl>(\mbox{\hyperlink{namespacecommon}{common}});}
...
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00477}00477\ \ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacecommon}{common}}\ =\ std::make\_shared<trace\_api\_common\_impl>();}
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00478}00478\ \ \ \ \mbox{\hyperlink{namespacecommon}{common}}-\/>plugin\_initialize(options);}
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00479}00479\ }
\DoxyCodeLine{\Hypertarget{trace__api__plugin_8cpp_source_l00480}00480\ \ \ \ rpc\ =\ std::make\_shared<trace\_api\_rpc\_plugin\_impl>(\mbox{\hyperlink{namespacecommon}{common}});}
