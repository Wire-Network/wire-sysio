...
namespace savanna_cluster {
   ...
   using account_name     = sysio::chain::account_name;
   using finalizer_policy = sysio::chain::finalizer_policy;
   using digest_type      = sysio::chain::digest_type;
   using block_header     = sysio::chain::block_header;
   using tester           = sysio::testing::tester;
   using setup_policy     = sysio::testing::setup_policy;
   using fsi_t            = sysio::chain::finalizer_safety_information;
