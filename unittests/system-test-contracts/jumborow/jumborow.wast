   ...
   (func $apply (param $receiver i64) (param $account i64) (param $action_name i64)
      ...
      (block $break
         (loop $loop
            ...
            ;; kv_set(table_id=0, payer=receiver, key_ptr=0, key_size=4, value_ptr=4, value_size=262000)
            ;; Bill the receiver (this contract's own account); payer 0 (same_payer) is rejected on insert.
            (drop (call $kv_set (i32.const 0) (get_local $receiver) (i32.const 0) (i32.const 4) (i32.const 4) (i32.const 262000)))
