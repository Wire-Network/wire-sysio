...
(module
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (if (i64.eq (get_local $2) (i64.const 1)) (then
    (call $sysio_assert (i64.eq (get_global $g0) (i64.const 2)) (i32.const 0))
    (return)
  ))
  (call $sysio_assert (i32.const 0) (i32.const 0))
 )
...
(module
 (import "env" "require_auth" (func $require_auth (param i64)))
 (import "env" "sysio_assert" (func $assert (param i32 i32)))
...
"(module"                                                                             \
" (export \"apply\" (func $apply))"                                                   \
" (import \"" SYSIO_INJECTED_MODULE_NAME "\" \"checktime\" (func $inj (param i32)))"  \
" (func $apply (param $0 i64) (param $1 i64) (param $2 i64))"                         \
")";

static const char import_wrong_signature_wast[] = R"=====(
(module
 (import "env" "sysio_assert" (func (param i32 i64)))
 (func (export "apply") (param i64 i64 i64))
)
)=====";
...
(module
 (import "env" "abort" (func $abort))
 (import "env" "sysio_exit" (func $sysio_exit (param i32)))
 (export "apply" (func $apply))
 (start $dothedew)
 (func $dothedew
   (call $sysio_exit (i32.const 0))
 )
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
   (call $abort)
 )
