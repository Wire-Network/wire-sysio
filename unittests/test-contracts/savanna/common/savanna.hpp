...
namespace savanna {
   ...
   struct authseq {
      name account;
      uint64_t sequence = 0;
      SYSLIB_SERIALIZE( authseq, (account)(sequence) )
   };
   ...
   struct action :  action_base {
      ...
      SYSLIB_SERIALIZE( action, (account)(name)(authorization)(data)(return_value))
   };
   ...
   struct action_data_internal : action_data {
      ...
      checksum256 digest() const {
         auto result = sysio::pack(*this);
         checksum256 hash = sha256(result.data(), result.size());
         return hash;
      };

      SYSLIB_SERIALIZE( action_data_internal, (receiver)(recv_sequence)(action.account)(action.name)(resolved_action_digest)(witness_hash))
   };
   ...
   struct block_finality_data {
      ...
      checksum256 resolve_witness() const {
         ...
         if (pending_finalizer_policy.has_value()  
            ...
            auto l2_packed = sysio::pack(level_2_commitments_t{
   ...
   struct block_finality_data_internal : block_finality_data {
      ...
      SYSLIB_SERIALIZE(block_finality_data_internal, (major_version)(minor_version)(active_finalizer_policy_generation)(resolved_last_pending_finalizer_policy_generation)(finality_mroot)(resolved_witness_hash))
   };
   ...
   struct extended_block_data_internal : extended_block_data {
      ...
      SYSLIB_SERIALIZE(extended_block_data_internal, (finality_data.major_version)(finality_data.minor_version)(dynamic_data.block_num)(resolved_timestamp)(resolved_parent_timestamp)(resolved_finality_digest)(resolved_action_mroot))
   };
   ...
   struct simple_block_data_internal : simple_block_data {
      ...
      SYSLIB_SERIALIZE(simple_block_data_internal, (major_version)(minor_version)(dynamic_data.block_num)(resolved_timestamp)(resolved_parent_timestamp)(finality_digest)(resolved_action_mroot))
   };
