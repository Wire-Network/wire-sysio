...
CONTRACT ibc : public contract {
   public:
      ...
      TABLE storedpolicy : finalizer_policy_input {
         ...
         SYSLIB_SERIALIZE( storedpolicy, (generation)(threshold)(finalizers)(last_block_num)(cache_expiry))
