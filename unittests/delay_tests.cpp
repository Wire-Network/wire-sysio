...
BOOST_AUTO_TEST_CASE( link_delay_link_change_test ) { try {
   ...
   constexpr name proposal_2_name     = "prop2"_n;
   constexpr uint32_t delay_seconds_2 = 10;
   propose_approve_msig_linkauth_trx(chain, proposal_2_name, "second"_n, "tester"_n, delay_seconds_2);
...
BOOST_AUTO_TEST_CASE( link_delay_unlink_test ) { try {
   ...
   propose_approve_msig_token_transfer_trx(chain, first_trnsfr_propsal_name, "tester"_n, first_trnsfr_delay_seconds, first_trnsfr_quantity);
   ...
   propose_approve_msig_unlinkauth_trx(chain, unlinkauth_proposal_name, "tester"_n, 10);
   ...
   propose_approve_msig_token_transfer_trx(chain, second_trnfr_propsal_name, "tester"_n, second_trnfr_delay_seconds, second_trnfr_quantity);
...
BOOST_AUTO_TEST_CASE( canceldelay_test2 ) { try {
...

   {
      ...
      trace = chain.push_action("sysio.token"_n, name("transfer"), vector<permission_level>{{"tester"_n, "first"_n}}, fc::mutable_variant_object()
          ("from", "tester")
          ("to", "tester2")
          ("quantity", "1.0000 CUR")
          ("memo", "hi" ),
   ...
   {
      // this transaction will be delayed 10 blocks
      trace = chain.push_action("sysio.token"_n, name("transfer"), vector<permission_level>{{"tester"_n, "second"_n}}, fc::mutable_variant_object()
          ("from", "tester")
          ("to", "tester2")
          ("quantity", "5.0000 CUR")
          ("memo", "hi" ),
   ...
   {
      // this transaction will be delayed 10 blocks
      trace = chain.push_action("sysio.token"_n, name("transfer"), vector<permission_level>{{"tester"_n, config::owner_name}}, fc::mutable_variant_object()
          ("from", "tester")
          ("to", "tester2")
          ("quantity", "10.0000 CUR")
          ("memo", "hi" ),
