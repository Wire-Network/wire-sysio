...
using bs            = sysio::chain::block_state;
using bsp           = sysio::chain::block_state_ptr;
using bhs           = sysio::chain::block_header_state;
using bhsp          = sysio::chain::block_header_state_ptr;
