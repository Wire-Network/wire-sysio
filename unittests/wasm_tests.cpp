...
BOOST_AUTO_TEST_CASE( billed_cpu_test ) try {
   ...
   auto push_trx = [&]( const transaction_metadata_ptr& trx, fc::time_point deadline,
      ...
      auto r = chain.control->test_push_transaction( trx, deadline, fc::microseconds::maximum(), billed_cpu_us, explicit_billed_cpu_time, subjective_cpu_bill );
   ...
   push_trx( ptrx, fc::time_point::maximum(), billed_cpu_time_us, false, {{acc, fc::microseconds(subjective_cpu_bill_us)}} );
   ...
   BOOST_CHECK_EXCEPTION(push_trx( ptrx, fc::time_point::maximum(), billed_cpu_time_us, false, {{acc, fc::microseconds(subjective_cpu_bill_us)}} ), tx_cpu_usage_exceeded,
