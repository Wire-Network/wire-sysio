...
BOOST_AUTO_TEST_CASE(constructor_test) {
	...
	fc::time_point t(fc::seconds(1764799180));
	block_timestamp_type bt2(t);
	BOOST_TEST( bt2.slot == (1764799180u - config::block_timestamp_epoch/1000)*2, "Time point constructor gives wrong value");
}
...
BOOST_AUTO_TEST_CASE(conversion_test) {
	...
	t = (fc::time_point)bt1;
	BOOST_TEST(t.time_since_epoch().to_seconds() == config::block_timestamp_epoch/1000+(200*config::block_interval_ms/1000), "Time point conversion failed");
