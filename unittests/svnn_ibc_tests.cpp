...
BOOST_AUTO_TEST_SUITE(svnn_ibc)
   ...
   BOOST_AUTO_TEST_CASE(ibc_test) { try {
      ...
      catch(const sysio_assert_message_exception& e){ last_action_failed = true; }
   ...
   BOOST_AUTO_TEST_CASE(bitset_tests) { try {
      ...
      chain.set_code( "ibc"_n, sysio::testing::test_contracts::ibc_wasm());
      chain.set_abi( "ibc"_n, sysio::testing::test_contracts::ibc_abi());
